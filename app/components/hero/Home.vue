  ...
  <hero v-bind="$props" class="home-hero">
    <template slot="hero-svg">
      <svg class="hero-svg"
        ...
        <defs>
          <mask id="mask">
            <circle cx="50%" cy="50%" r="100%" fill="white" ref="circleMask" />
          </mask>
        </defs>
	...
	c0-0.3,0-48.6,0-144.7H554.7c-1.2,0-2.3-0.1-3.4-0.1H322.2" />
        ...
        <path ref="svgLogo__back" class="path logo back" d="M322.2,0C129.2,0,21.8,90.8,0,272.3c11.9,5.1,90.2,39.2,109.3,62.9c21.5-1.2,35.5,13.4,39.8,21.2
          ...
          c90.2,0,136.5-50.1,138.8-150.3v-5.4c0-0.3,0-48.6,0-144.7H554.7c-1.2,0-2.3-0.1-3.4-0.1H322.2" mask="url(#mask)" />
...
export default {
  ...
  mounted() {
    ...
    timeline
      ...
      .from(this.$refs.circleMask, 2, { scale: 0, transformOrigin: '50% 50%' }, "line2-=.3")
      .staggerFrom(
        chars,
        0.7,
        {
