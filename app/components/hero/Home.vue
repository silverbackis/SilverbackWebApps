  ...
  <hero v-bind="$props" class="home-hero">
    <template slot="hero-svg">
      <svg class="hero-svg"
           ...
           viewBox="-2 -2 795.6 1116.6" xml:space="preserve">
        <defs>
          <clipPath id="clip-path">
            <rect x="50%" y="-40%" width="0%" height="140%" fill="white" class="clip-rectangle top" ref="clipRectangle__top" style="display: none;" />
          </clipPath>
        </defs>
        <path ref="svgLogo__noFace" class="path noface" d="M341,14.5c-193,0-300.4,90.8-322.2,272.3c-2.5,23.1-4.4,43.6-4.8,71.2c-0.2,12.3-0.4,16.4-0.1,23
        ...
        <path ref="svgLogo__back" class="path logo back" d="M341,14.5c-193,0-300.4,90.8-322.2,272.3c11.9,5.1,90.2,39.2,109.3,62.9c21.5-1.2,35.5,13.4,39.8,21.2
		...
		c-1.2,0-2.3-0.1-3.4-0.1H341" clip-path="url(#clip-path)" />

        <path ref="svgLogo__top" class="path logo top" d="M341,14.5c-193,0-300.4,90.8-322.2,272.3c11.9,5.1,90.2,39.2,109.3,62.9c21.5-1.2,35.5,13.4,39.8,21.2
		c8.2,1.6,7,9.8,7,9.8s-3.5,22.4-10.2,28.5c4.3,7.3-1.6,10.6-1.6,10.6s-2.7,13,13.3,26.1c15.6,7.3,25.8,4.1,44.5,27.7
		c11.3,3.3,16.4,9,16.4,9s2,13,14.8,22c12.5,17.1,6.6,22.8,22.6,49.7c13.6,6.5,16.8,15.1,10.1,26.1c-4.7,4.1-29.3,54.2-67.1,49.7
		c-15.5,10.5-43.3,14.8-63.7,23.8c44.6,23,100,34.5,166,34.5h147.5c19.7,0,34.2,5.8,43.4,17.3c9.2,11.5,13.9,23.8,13.9,37.1
		s-4.6,25.6-13.9,37.1s-23.7,17.2-43.4,17.2H169.1c-90.2,0-136.6,50.1-138.8,150.3l-0.2,150H156c3.7,0.2,7.4,0.4,11.3,0.4h284.6
...
export default {
  ...
  mounted() {
    const timeline = new this.$gsap.timeline()
    timeline
      ...
      .to(this.$refs.clipRectangle__top, 1.2, { attr: { x: '-90%', width: '240%' }, ease: Power1.easeOut }, "mask")
      .from(
      ...
      .add(() => { this.$root.$emit('heroAnimate') }, "-=2")
  }
}
</script>
